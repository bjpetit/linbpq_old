...
char * WebMailMsgtxt()
{
    ...
    "<label class=\"hamb\" for=\"side-menu\"><span class=\"hamb-line\"></span></label>"
		"<nav class=\"nav\">"
    "<ul class=\"menu\">"
		"  <li><a href=\"#\" onclick=\"Reply('%d' ,'%s'); return false;\">Reply</a></li>"
		"  <li><a href=/WebMail/WMDel/%d?%s>Kill Message</a></li>"
		"  %s"
		"  <li><a href=/WebMail/WMNext?%s>Next</a></li>"
		"  <li><a href=/WebMail/WMPrev?%s>Previous</a></li>"
...
char * FwdPagetxt()
{
	char Msg[] =
		...
		"<header class=\"header\">"
    "<a href=\"#\" class=\"logo\">BPQ32 BBS %s</a>"
		"<input class=\"side-menu\" type=\"checkbox\" id=\"side-menu\"/>"
    "<label class=\"hamb\" for=\"side-menu\"><span class=\"hamb-line\"></span></label>"
		"<nav class=\"nav\">"
    "<ul class=\"menu\">"
		"  <li><a href=\"/Mail/Status?%s\">Status</a></li>"
		"  <li><a href=\"/Mail/Conf?%s\">Configuration</a></li>"
		"  <li><a href=\"/Mail/Users?%s\">Users</a></li>"
		"  <li><a href=\"/Mail/Msgs?%s\">Messages</a></li>"
		"  <li><a href=\"/Mail/FWD?%s\">Forwarding</a></li>"
		"  <li><a href=\"/Mail/Wel?%s\">Welcome Msgs &amp; Prompts</a></li>"
		"  <li><a href=\"/Mail/HK?%s\">Housekeeping</a></li>"
		"  <li><a href=\"/Mail/WP?%s\">WP Update</a></li>"
...
char * WebMailPagetxt()
{
	char Msg[] =
		...
		"<header class=\"header\">"
    "<a href=\"#\" class=\"logo\">%s Webmail Interface - User %s - Message List</a>"
		"<input class=\"side-menu\" type=\"checkbox\" id=\"side-menu\"/>"
    "<label class=\"hamb\" for=\"side-menu\"><span class=\"hamb-line\"></span></label>"
		"<nav class=\"nav\">"
    "<ul class=\"menu\">"
...
char * ChatConfigtxt()
{
	char Msg[] =
		...
		"<header class=\"header\">"
    "<a href=\"#\" class=\"logo\">BPQ32 Chat Node %s</a>"
		"<input class=\"side-menu\" type=\"checkbox\" id=\"side-menu\"/>"
    "<label class=\"hamb\" for=\"side-menu\"><span class=\"hamb-line\"></span></label>"
		"<nav class=\"nav\">"
    "<ul class=\"menu\">"
		"  <li><a href=\"/Chat/ChatStatus?%s\">Status</a><l/i>\r\n"
		"  <li><a href=\"/Chat/ChatConf?%s\">Configuration</a></li>\r\n"
		"  <li><a href=\"/\">Node Menu</a></li>\r\n"
		"</ul></nav></header>"
		"<br>\r\n"
...
char * ChatStatustxt()
{
	char Msg[] =
		...
		"\r\n"
		"<header class=\"header\">"
    "<a href=\"#\" class=\"logo\">BPQ32 Chat Server %s</a>"
		"<input class=\"side-menu\" type=\"checkbox\" id=\"side-menu\"/>"
    "<label class=\"hamb\" for=\"side-menu\"><span class=\"hamb-line\"></span></label>"
		"<nav class=\"nav\">"
    "<ul class=\"menu\">"
		"  <li><a href=\"/Chat/ChatStatus?%s\">Status</a></li>\r\n"
		"  <li><a href=\"/Chat/ChatConf?%s\">Configuration</a></li>\r\n"
		"  <li><a href=\"/\">Node Menu</a></li>\r\n"
		"</ul></nav></header>"
		"\r\n"
